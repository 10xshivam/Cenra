...
export const SettingsView = () => {
    return (
        <div className="w-full h-full flex flex-col gap-6 p-6 md:p-8 lg:p-12 pb-24 max-w-6xl mx-auto overflow-y-auto no-scrollbar">
            {/* Page header */}
            <div className="rounded-2xl w-full p-2 pb-5 bg-neutral-200 mb-5">
                <div className="flex flex-col gap-2 w-full border border-neutral-400 rounded-xl p-5 bg-neutral-50">
                    ...
                    <span className="text-sm text-neutral-500 tracking-tight leading-relaxed">
                        Manage your account information, workspace configuration, and subscription preferences. Update profile details, customize workspace settings, and review your billing and subscription plan.
                    </span>
                </div>
            </div>

            <Tabs defaultValue="profile">
                <TabsList className="h-11! w-full bg-white border border-dashed border-neutral-300 rounded-xl p-1 gap-1 mb-2">
                    <TabsTrigger
                        value="profile"
