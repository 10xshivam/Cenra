...
export const integrations = [
    {
        ...
        description: "Embed Cenra in any plain HTML website.",
        icon: IconBrandHtml5,
        lang: "html",
        getCode: (workspaceId: string) => `<!-- Add this before the closing </body> tag -->\n<script src="http://localhost:3001/widget.js" data-workspace-id="${workspaceId}"></script>`,
    },
    {
        id: "react",
        name: "React",
