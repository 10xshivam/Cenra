...
export const SectionCard = ({
  ...
  <div className="rounded-2xl w-full p-1.5 bg-neutral-200 border border-dashed border-neutral-400">
    <div className="rounded-xl shadow-sm bg-neutral-50 p-6 space-y-5">
